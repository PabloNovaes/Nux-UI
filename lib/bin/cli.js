...
process.on("SIGINT", () => {
    console.log("\n" + chalk.yellow("✋ Operação cancelada pelo usuário."));
    process.exit(0);
});
...
const REPO_RAW_BASE = "https://raw.githubusercontent.com/PabloNovaes/Nux-UI/main/lib/components";
const REPO_API_URL = "https://api.github.com/repos/PabloNovaes/Nux-UI/contents/lib/components";
...
function showBanner() {
    console.log(
        ...
        ], { interpolation: "rgb" })(figlet.textSync("Nux UI"))
    );
...
program
    ...
    .action(() => {
        ...
        console.log("  - Add a component: npx nuxui add title");
    ...
    .action(async (component) => {
        ...
        if (!selected) {
            try {
                ...
                console.log("\n" + chalk.yellow("✋ Operação cancelada."));
                process.exit(0);
            }
        }
...
program
    ...
    .action(async () => {
        ...
        console.log(chalk.blue("\n💡 Examples:"));
        console.log("  npx nuxui add <component-name> or all");
    });
...
program
    ...
    .action(() => {
        ...
        console.log(chalk.blue("\n📖 Examples:"));
        console.log("  npx nuxui init");
        console.log("  npx nuxui add title");
